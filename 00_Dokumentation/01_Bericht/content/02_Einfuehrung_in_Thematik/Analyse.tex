...
\section{Situationsanalyse} \label{Situationsanalyse}
	...
	\\
		...
		Der dargestellte Reaktor hat zum Beispiel folgende Funktionen:
		\begin{itemize}
			\item Befüllen
			\item Kühlen
			\item Mischen
	...
	\\
		...
		\begin{figure}[h!]
			\centering
			\includegraphics[width=0.6\textwidth]{02_Einfuehrung_in_Thematik/ABB_EGM}
			\captionsetup{justification=centering}
		...
		\begin{figure}[h!]
			\centering
			\includegraphics[width=1\textwidth]{02_Einfuehrung_in_Thematik/ABB_OPC}
		...
		\begin{figure}[h!]
			\centering
			\includegraphics[width=0.6\textwidth]{02_Einfuehrung_in_Thematik/KUKA_MxA}
			\captionsetup{justification=centering}
